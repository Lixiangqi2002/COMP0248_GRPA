    ...
    for root, _, files in os.walk(split_dir):
        for file in files:
            if file.endswith("_mask.npy"):
                ...
                # NOTE: I'm not sure if mask is exactly the same in point location as pc 
                ...
                # TODO
                # full_path = file_path.replace('_mask.npy', '_full.npy')  # full path
                # entries.append(f"{full_path} {label}\n")
