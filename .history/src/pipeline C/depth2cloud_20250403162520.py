...
if __name__ == '__main__':
    ...
    save_label_file_mapping("data/dataset/point_clouds/train", "data/dataset/point_clouds/train/train_labels.txt")
    save_label_file_mapping("data/dataset/point_clouds/test", "data/dataset/point_clouds/test/test_labels.txt")