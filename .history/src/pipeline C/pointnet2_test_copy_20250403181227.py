    ...
    with torch.no_grad():
        ...
        for batch_idx, (points, labels) in tqdm(enumerate(test_loader), total=len(test_loader)):
            ...
            for _ in range(args.num_votes):
                ...
                # reshapeqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq
                ...
                iou = compute_iou(pred_labels[b], gt_labels[b], class_id=1)
                print(f"Batch {batch_idx}, Point {n}, IoU: {iou:.4f}")
